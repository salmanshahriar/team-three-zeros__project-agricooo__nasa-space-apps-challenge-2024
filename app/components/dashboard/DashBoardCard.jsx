...
const DashBoardCard = ({ img, name, onClick, deviceName }) => {
    ...
    isPressable
    radius="lg"
    className="relative border-none bg-white/10 shadow-xl animate-slide-up rounded-xl w-11/12 flex flex-col transform transition-transform duration-300 hover:scale-105 mb-7 h-52"
>
    <Image
