...
function Navbar() {
  ...
  return (
    <header className="fixed z-50 bottom-0 left-1/2 transform -translate-x-1/2 w-80 bg-gradient-to-r from-blue-500 to-purple-600 p-1 rounded-full shadow-2xl backdrop-blur-lg border border-gray-200">
