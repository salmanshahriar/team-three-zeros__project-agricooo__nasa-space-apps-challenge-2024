...
const Dashboard = () => {
    ...
    return (
        <>
            <div className="mx-auto p-2 sm:w-4/5 md:w-2/3 lg:w-1/2 xl:w-1/3 min-h-screen flex flex-col items-center bg-gradient-to-br from-gray-700 via-indigo-900 to-gray-600">
